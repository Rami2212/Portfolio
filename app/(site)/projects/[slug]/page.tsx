            ...
            {project.githubUrl && githubLinkVisible && (
              ...
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 0C5.37 0 0 5.373 0 12c0 5.303 3.438 9.8 8.205 11.387.599.111.82-.261.82-.58 0-.287-.011-1.244-.017-2.44-3.338.726-4.042-1.61-4.042-1.61-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.73.083-.73 1.205.084 1.84 1.237 1.84 1.237 1.07 1.834 2.807 1.304 3.492 .997 .108-.775 .419-1.305 .762 -1.605 -2.665 -.305 -5.467 -1.332 -5.467 -5.931 0 -1 .357 -1.815 .944 -2.455 -.094 -.303 -.41 -1 .09 -2 .077 -.303 .307 -1 .082 -2 .076 -.303 .315 -1 .08 -2 .489 -.303 1.6 -.099 2 .075 .6 -.188 2 -.75 3 -.903 .108 -.303 .41 -1 .08 -2 .076 -.303 .315 -1 .08 -2 .489 -.303 1.6 -.099 2 .075 .6 -.188 2 -.75 3 -.903C19 .815 19.702 2 19.702 2c0 .99 .36 1.83 .944 2.455C21 .815 21 .815C21 .815C21 .815C21 .815C21 .815C21 .815C21 .815C21 .815C21 .815C21 .815C21 .815C21 .815C21 .815C21 .815C21 C12z" />  
                </svg>
                View on GitHub
              </a>
            )}  
